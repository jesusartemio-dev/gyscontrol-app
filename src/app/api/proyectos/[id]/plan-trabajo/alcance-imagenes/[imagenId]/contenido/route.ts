...
// GET /api/proyectos/[id]/plan-trabajo/alcance-imagenes/[imagenId]/contenido
// Sirve el binario de la imagen (proxy cacheado de Drive) para el preview en la UI.
export async function GET(_req: NextRequest, { params }: Ctx) {
  ...
  if (!imagen.driveFileId) {
    return NextResponse.json({ error: 'Imagen sin archivo asociado en Drive' }, { status: 404 })
  }

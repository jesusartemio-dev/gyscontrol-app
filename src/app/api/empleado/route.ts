  ...
  try {
    ...
    const data = await prisma.empleado.create({
      data: {
        ...
        tipoPersonal: body.tipoPersonal === 'tercero' ? 'tercero' : 'planilla',
        tarifaDia: body.tarifaDia ? parseFloat(body.tarifaDia) : null,
        monedaTarifa: body.monedaTarifa === 'USD' ? 'USD' : 'PEN',

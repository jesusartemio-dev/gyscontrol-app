...
export default function OportunidadDetailPage() {
  ...
  const loadOportunidad = async () => {
    try {
      ...
      // Si hay cotización, cargar datos completos y verificar si existe proyecto
      if (data.cotizacionId) {
        try {
          ...
          // Buscar proyecto asociado a esta cotización
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center space-y-3">
          ...
          <Button size="sm" onClick={() => router.push('/crm')}>
  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <div className="space-y-3">
        {/* Línea 1: Navegación + Título + Prioridad + Editar */}
        <div className="flex items-center gap-2">
          <Button variant="ghost" size="sm" onClick={() => router.push('/crm')} className="h-8 px-2">
        ...
        {/* Línea 3: Metadata inline con stats */}
      ...
      <div className="space-y-4">
        ...
        {/* Descripción + Info adicional inline */}
        ...
        {/* Actividades - el botón "Agregar" está dentro del componente */}
        <ActividadList
          oportunidadId={id}

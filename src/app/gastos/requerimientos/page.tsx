...
const ALLOWED_ROLES = ['admin', 'gerente', 'gestor', 'coordinador', 'coordinador_logistico', 'administracion']
              ...
              <TableBody>
                {currentList.map(hoja => (
                  <TableRow
                    ...
                    onClick={() => router.push(`/gastos/mis-requerimientos/${hoja.id}?from=requerimientos`)}
                  >

...
import { Loader2, FileSpreadsheet, Trash2, Search, ArrowUp, ArrowDown, MapPin, Smartphone, MapPinOff, Moon, Home, Briefcase, AlertTriangle } from 'lucide-react'
...
export default function AsistenciaRRHH() {
  ...
  const [vista, setVista] = useState<'detalle' | 'resumen' | 'horas_dia' | 'ranking' | 'sesiones'>('detalle')
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Marcajes del equipo — puntualidad, tardanzas y dispositivos
          </p>
        </div>
      </div>

      ...
      <div className="w-full max-w-md rounded-xl bg-background shadow-2xl">
        ...
        <div className="space-y-4 px-6 py-5">
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              placeholder="Ej: Ajuste por acuerdo de gerencia..."
              rows={3}
              value={motivo}
...
export default function SaldosAusenciaPage() {
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">Saldos de Ausencia</h1>
            <p className="text-sm text-muted-foreground">Gestión de saldos por colaborador y año</p>
          </div>
        </div>

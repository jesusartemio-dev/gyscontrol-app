            ...
            return (
              <React.Fragment key={tipo}>
                ...
                >
                  ...
                  {cronograma && (cronograma.bloqueado || cronograma.esBaseline || cronograma.tipo === 'comercial') && (
                    <Lock className="h-3 w-3 text-amber-500 ml-1" />
                  )}
                  {info.readOnly && cronograma && !cronograma.bloqueado && !cronograma.esBaseline && cronograma.tipo !== 'comercial' && (

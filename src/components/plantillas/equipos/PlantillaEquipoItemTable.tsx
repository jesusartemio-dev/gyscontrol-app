...
export default function PlantillaEquipoItemTable({ items, onUpdated, onDeleted }: Props) {
  ...
  const guardarCambios = (item: PlantillaEquipoItem) => {
    if (editCantidad <= 0) {
    ...
    const actualizado: PlantillaEquipoItem = {
      ...item,

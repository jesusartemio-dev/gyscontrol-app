// ===================================================
// 📁 Archivo: PlantillaGastoList.tsx
// 📌 Ubicación: src/components/plantillas/PlantillaGastoList.tsx
// 🔧 Descripción: Lista de grupos de gasto con opción de edición inline
//
// 🧠 Uso: Se usa dentro de una página para mostrar todas las secciones de gasto
...
interface Props {
  ...
  onUpdate: (id: string, payload: Partial<PlantillaGasto>) => void
}

export default function PlantillaGastoList({ data, onDelete, onUpdate }: Props) {

...
import { ListaEquipoItemPayload } from '@/types'
import { toast } from 'sonner'

interface Props {
  listaId: string
  onCreated: (item: ListaEquipoItemPayload) => void
}

export default function ListaEquipoItemForm({ listaId, onCreated }: Props) {
  const [form, setForm] = useState<ListaEquipoItemPayload>({
    listaId,
    codigo: '',
    descripcion: '',
    unidad: '',

// ===================================================
// 📁 Archivo: UnidadModal.tsx
// 📌 Ubicación: src/components/catalogo/
// 🔧 Modal para crear unidades
//
// 🧠 Uso: Modal que se abre desde la página de unidades
...
export default function UnidadModal({ isOpen, onClose, onCreated }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true)
    try {
      const payload: UnidadPayload = { nombre: nombre.trim() }
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Agrega una nueva unidad de medida para los equipos del catálogo
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500">
              💡 Ejemplos: "unidad", "metro", "litro", "kilogramo", "m²", "kg"
            </p>
          </div>

// ===================================================
// 📁 Archivo: UnidadServicioCardView.tsx
// 📌 Ubicación: src/components/catalogo/
// 🔧 Vista de cards para unidades de servicio
//
// 🧠 Uso: Vista de tarjetas de unidades de servicio con edición inline
...
export default function UnidadServicioCardView({ data, onUpdate, onDelete, loading = false, error = null }: Props) {

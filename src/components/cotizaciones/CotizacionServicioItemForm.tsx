// ===================================================
// 📁 Archivo: CotizacionServicioItemForm.tsx
// 📌 Ubicación: src/components/cotizaciones/
// 🔧 Descripción: Formulario para agregar ítems a una sección de servicios de cotización
//
// 🧠 Uso: Se utiliza al seleccionar ítems desde catálogo para incluir en una cotización

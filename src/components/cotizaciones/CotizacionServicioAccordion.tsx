...
import CotizacionServicioItemList from './CotizacionServicioItemList'
      ...
      <AccordionItem value={servicio.id}>
        ...
        <AccordionContent className="px-6 pb-6 space-y-4">
          <div className="flex justify-end">
            <button
              onClick={() =>
                router.push(`/comercial/cotizaciones/${cotizacionId}/servicio/select?grupo=${servicio.id}`)
              }

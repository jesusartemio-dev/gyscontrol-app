// ===================================================
// 📁 Archivo: CotizacionEquipoModal.tsx
// 📌 Ubicación: src/components/cotizaciones/
// 🔧 Descripción: Modal mejorado para crear nuevas secciones de equipo en cotizaciones
...
import { createCotizacionEquipo } from '@/lib/services/cotizacionEquipo'
import type { CotizacionEquipoPayload } from '@/types'
...
export default function CotizacionEquipoModal({ 
  cotizacionId, 
  onCreated, 
  trigger, 
  open: externalOpen, 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload: CotizacionEquipoPayload = {
      cotizacionId,
      nombre: nombre.trim(),
    ...
    try {
      setLoading(true)
      const nuevo = await createCotizacionEquipo(payload)
    ...
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Crea una nueva sección para agrupar equipos relacionados en la cotización.
          </DialogDescription>
        </DialogHeader>

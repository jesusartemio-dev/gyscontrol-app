// ===============================
// 📁 categoriaExclusionImportUtils.ts
// ===============================
import * as XLSX from 'xlsx'

export interface CategoriaExclusionImportada {
  nombre: string
  descripcion?: string
}

export async function leerCategoriasExclusionDesdeExcel(file: File): Promise<CategoriaExclusionImportada[]> {
...
export function validarCategoriasExclusion(
  categorias: CategoriaExclusionImportada[],
  existentes: string[]
): {
  nuevas: CategoriaExclusionImportada[]
  errores: string[]
  duplicados: string[]
} {
  const nuevas: CategoriaExclusionImportada[] = []

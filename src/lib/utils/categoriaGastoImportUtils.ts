// ===============================
// 📁 categoriaGastoImportUtils.ts
// ===============================
import * as XLSX from 'xlsx'

export interface CategoriaGastoImportada {
  nombre: string
  descripcion?: string
}

export async function leerCategoriasGastoDesdeExcel(file: File): Promise<CategoriaGastoImportada[]> {
...
export function validarCategoriasGasto(
  categorias: CategoriaGastoImportada[],
  existentes: string[]
): {
  nuevas: CategoriaGastoImportada[]
  errores: string[]
  duplicados: string[]
} {
  const nuevas: CategoriaGastoImportada[] = []

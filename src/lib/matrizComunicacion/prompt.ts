...
RESPONSABILIDAD (combinar letras):
  ...
  IMPORTANTE: NO uses la letra "R" (Autoriza) en ninguna celda — ese código
  se calcula y aplica por separado en base al organigrama del proyecto, no
  es algo que la IA deba decidir. Usa solo D, E, S, V y sus combinaciones.

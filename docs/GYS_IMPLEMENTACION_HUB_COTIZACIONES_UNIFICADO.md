...
### 🆕 **Actualizaciones del Modelo de Cotización**
- **Fechas Base**: Nuevos campos `fechaInicio` y `fechaFin` en el modelo `Cotizacion`
- **Propósito**: Establecer línea base temporal para cronogramas de 6 niveles
- **Integración**: Fechas se copian automáticamente al convertir cotización a proyecto
